from retranslate_constant import language_short_tencent, app_secret_tencent, app_key_tencent
...
def get_params(text, from_l="zh", to_l="en"):
    ...
    signs += 'app_key={}'.format(app_secret_tencent)
